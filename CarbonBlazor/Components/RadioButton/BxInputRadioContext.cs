...
{
    internal class BxInputRadioContext
    {
        private readonly BxInputRadioContext? _parentContext;
        ...
        public BxInputRadioContext(
            BxInputRadioContext? parentContext,
            string groupName,
            object? currentValue,
            string fieldClass,
        ...
        public BxInputRadioContext? FindContextInAncestors(string groupName)
