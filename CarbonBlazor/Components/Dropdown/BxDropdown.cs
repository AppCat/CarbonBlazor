...
namespace CarbonBlazor.Components
{
    ...
    /// </summary>
    public partial class BxDropdown : BxListBoxComponentBase<BxDropdownOption>
    {
        /// <summary>
        /// 设置映射
        /// </summary>
        ...
        internal override RenderFragment ContentFragment() => __builder =>
        {
            RenderFragment button = __builder =>
            {
                ...
                __builder.AddConfig(ref sequence, new BxComponentConfig(ButtonConfig).AddClass($"bx--list-box__field").AddId($"{Id}-button"));
            ...
            RenderFragment dropdown = __builder =>
            {
                ...
                __builder.OpenElement(sequence++, "div");
                __builder.AddConfig(ref sequence, new BxComponentConfig(DropdownConfig)
                    .AddClass($"bx--dropdown bx--list-box")
