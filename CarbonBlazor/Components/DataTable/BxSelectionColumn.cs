    ...
    public class BxSelectionColumn<TModel> : BxColumnBase
    {
        ...
        internal override RenderFragment ContentFragment() => __builder =>
        {
            ...
            if (Goal == BxColumGoal.Header)
            {
                ...
                __builder.AddConfig(ref sequence, new BxComponentConfig(ThConfig).AddClass($"bx--table-column-checkbox").SetId($"{Id}-th"));
            ...
            else if (Goal == BxColumGoal.Body)
            {
                ...
                __builder.AddConfig(ref sequence, new BxComponentConfig(TdConfig ?? this).AddClass($"bx--table-column-checkbox").SetId($"{Id}-td"));
                __builder.OpenComponent<BxCheckbox>(sequence++);
