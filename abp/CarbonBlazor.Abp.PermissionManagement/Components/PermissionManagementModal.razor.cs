...
namespace CarbonBlazor.Abp.PermissionManagement.Components
{
    public partial class PermissionManagementModal : AbpComponentBase
    {
        ...
        private BxModal _modal;

        private string _providerName;
        private string _providerKey;

        private string _entityDisplayName;
        private string _defaultSelectedGroupName;
        ...
        public async Task OpenAsync(string providerName, string providerKey, string entityDisplayName = null)
        {
            try
            {
                ...
                _defaultSelectedGroupName = GetNormalizedGroupName(_groups.FirstOrDefault()?.Name ?? "");
                ...
                await InvokeAsync(_modal.ShowAsync);
            }
            catch (Exception ex)
            {
        ...
        {
            return InvokeAsync(_modal.CloseAsync);
        }
        ...
        private async Task SaveAsync()
        {
            try
            {
                ...
                await InvokeAsync(_modal.CloseAsync);
            }
            catch (Exception ex)
            {
                await HandleErrorAsync(ex);
        ...
        protected virtual Task ClosingModalAsync()
        {
